 ...
 *
 * @method static \YukataRm\Interface\File\OperatorInterface|null create(string $path)
 *
 * @method static bool remove(string $path)
 *
 * @method static \YukataRm\Interface\File\OperatorInterface|null copy(string $source, string $destination)
 *
 * @method static \YukataRm\Interface\File\OperatorInterface|null move(string $source, string $destination)
 *
 * @method static \YukataRm\Interface\File\OperatorInterface|null zip(string $path, string|null $destination = null)
 * @method static \YukataRm\Interface\File\OperatorInterface|array|null unzip(string $path, string|null $destination = null)
 *
