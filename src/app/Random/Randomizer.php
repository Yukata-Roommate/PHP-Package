...
namespace YukataRm\Random;

use YukataRm\Interface\Random\RandomizerInterface;
...
class Randomizer implements RandomizerInterface
{
     ...
     */
    protected function randomizer(): PHPRandomizer
    {
        return new PHPRandomizer();
    }
