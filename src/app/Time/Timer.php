...
class Timer implements TimerInterface
{
     ...
     * @return string
     */
    public function startDateTime(string|null $format = null): string
    {
     ...
     * @var float
     */
    protected float $stopTimestamp = 0;
     ...
     * @return string
     */
    public function stopDateTime(string|null $format = null): string
    {
     ...
     * @var array<int, float>
     */
    protected array $splitTimestamps = [];
     ...
     */
    public function splitDateTimes(string|null $format = null): array
    {
